...
class CBChatbotAdminStack extends Stack {
  /**
   *
  ...
  constructor(scope, id, props) {
    ...
    const CBChatbotAdminLambda = createLambdaFunction(
      this,
      "CBChatbotAdminLambda",
      Runtime.NODEJS_16_X,
      "CBChatbotAdmin.handler",
      "src/chatbot/admin",
...
module.exports = { CBChatbotAdminStack };
