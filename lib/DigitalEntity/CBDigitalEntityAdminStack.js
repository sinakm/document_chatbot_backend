...
class CBDigitalEntityAdminStack extends Stack {
  /**
   *
  ...
  constructor(scope, id, props) {
    ...
    const CBDigitalEntityAdminLambda = createLambdaFunction(
      this,
      "CBDigitalEntityAdminLambda",
      Runtime.NODEJS_16_X,
      "CBDigitalEntityAdmin.handler",
      "src/digitalEntity/admin",
...
module.exports = { CBDigitalEntityAdminStack };
